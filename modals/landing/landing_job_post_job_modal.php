    ...
    <div class="modal-content">
        ...
        <form id="job-post-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="job-salary" placeholder="e.g. $45,000 - $60,000">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea id="job-requirements" rows="5" placeholder="List the requirements for this position"></textarea>
            </div>
